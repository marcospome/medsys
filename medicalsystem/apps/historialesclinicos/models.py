...
class HistorialClinico(models.Model):
    ...
    antecedentefamiliar = models.CharField(verbose_name='Antecedentes Familiares', max_length=10000, blank=True)
    enfermedad = models.CharField(verbose_name='Enfermedad Actual', max_length=10000, blank=True)
    indicacion = models.CharField(verbose_name='Indicacion', max_length=10000, blank=True)
    problema = models.CharField(verbose_name='Problema', max_length=10000, blank=True)
    Detalle = models.CharField(verbose_name='Detalle', max_length=10000, blank=True)
